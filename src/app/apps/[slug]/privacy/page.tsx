...
export async function generateMetadata({
  ...
  if (!app || !legal) {
    return {
      title: 'Privacy Policy not found - George Valandis',
    };
  }
      ...
      <article className="max-w-3xl mx-auto px-6 lg:px-8 py-16 md:py-24">
        ...
        <section className="mt-10 border-t border-white/10 pt-8">
          ...
          <p className="text-sm leading-6 text-gray-400">
            This page describes privacy for the mobile app. The separate landing
            page privacy policy explains website hosting, cookies, and consent
            logging for georgevalandis.com.
          </p>
          <Link
            href={app.legal.privacyPath}
            className="mt-3 inline-flex text-amber-300 hover:text-amber-200 transition-colors underline"
          >
            Open landing page privacy policy
          </Link>
        </section>
      </article>
    </main>
