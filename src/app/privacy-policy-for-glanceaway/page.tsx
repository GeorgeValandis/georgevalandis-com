...
const targetPath = '/apps/glanceaway/privacy/';

export const metadata: Metadata = {
  title: 'Privacy Policy for GlanceAway - George Valandis',
  description: 'Privacy policy for the GlanceAway app.',
  robots: {
    index: false,
    follow: true,
  },
...
export default function GlanceAwayLegacyPrivacyPage() {
  return (
    <main className="min-h-screen bg-gray-950 px-6 py-16 text-gray-50">
      ...
      <section className="mx-auto max-w-2xl">
        ...
        >
          Open the current GlanceAway privacy policy
        </Link>
      </section>
    </main>
  );
